            ...
            <div x-show="mobileSheet"
                ...
                <div class="py-2">
                    ...
                    <div class="px-5 pt-2 pb-1">
                        @include('layouts._account-switcher', ['compact' => false, 'close' => 'mobileSheet = false'])
                    </div>
                ...
                <div class="relative" x-data="{ userMenu: false }">
                    ...
                    <div x-show="userMenu"
                        ...
                        <div class="px-2 pb-1 pt-1.5">
                            @include('layouts._account-switcher', ['compact' => true, 'close' => 'sidebarOpen = false; userMenu = false'])
                        </div>
